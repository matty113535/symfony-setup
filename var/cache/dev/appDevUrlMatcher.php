...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/build')) {
            // _assetic_aa12467
            if ($pathinfo === '/build/css/aa12467.css') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => 'aa12467',  'pos' => NULL,  '_format' => 'css',  '_route' => '_assetic_aa12467',);
            }

            // _assetic_db8ceae
            if ($pathinfo === '/build/js/db8ceae.js') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => 'db8ceae',  'pos' => NULL,  '_format' => 'js',  '_route' => '_assetic_db8ceae',);
            }
        ...
        if (0 === strpos($pathinfo, '/u')) {
            // user_profile
            if ($pathinfo === '/u/profile') {
                return array (  '_controller' => 'UserBundle\\Controller\\ProfileController::showAction',  '_route' => 'user_profile',);
            }

            // register_user
            if ($pathinfo === '/u/register') {
                return array (  '_controller' => 'UserBundle\\Controller\\RegistrationController::registerUserAction',  '_route' => 'register_user',);
            }
        ...
        if (0 === strpos($pathinfo, '/u')) {
            if (0 === strpos($pathinfo, '/u/log')) {
                if (0 === strpos($pathinfo, '/u/login')) {
            ...
            if (0 === strpos($pathinfo, '/u/re')) {
                if (0 === strpos($pathinfo, '/u/register')) {
                    // fos_user_registration_register
                    if (rtrim($pathinfo, '/') === '/u/register') {
                        if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    ...
                    if (0 === strpos($pathinfo, '/u/register/c')) {
                        // fos_user_registration_check_email
                        if ($pathinfo === '/u/register/check-email') {
                        ...
                        if (0 === strpos($pathinfo, '/u/register/confirm')) {
                            // fos_user_registration_confirm
                            if (preg_match('#^/u/register/confirm/(?P<token>[^/]++)$#s', $pathinfo, $matches)) {
                                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                                    $allow = array_merge($allow, array('GET', 'HEAD'));
                            ...
                            if ($pathinfo === '/u/register/confirmed') {
                                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                                    $allow = array_merge($allow, array('GET', 'HEAD'));
                ...
                if (0 === strpos($pathinfo, '/u/resetting')) {
                    // fos_user_resetting_request
                    if ($pathinfo === '/u/resetting/request') {
                        if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'HEAD'));
                    ...
                    if ($pathinfo === '/u/resetting/send-email') {
                        if ($this->context->getMethod() != 'POST') {
                            $allow[] = 'POST';
                    ...
                    if ($pathinfo === '/u/resetting/check-email') {
                        if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'HEAD'));
                    ...
                    if (0 === strpos($pathinfo, '/u/resetting/reset') && preg_match('#^/u/resetting/reset/(?P<token>[^/]++)$#s', $pathinfo, $matches)) {
                        if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/user/user')) {
                ...
                if ($pathinfo === '/admin/user/user/list') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::listAction',  '_sonata_admin' => 'user.admin.user',  '_sonata_name' => 'admin_user_user_list',  '_route' => 'admin_user_user_list',);
                }

                // admin_user_user_create
                if ($pathinfo === '/admin/user/user/create') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::createAction',  '_sonata_admin' => 'user.admin.user',  '_sonata_name' => 'admin_user_user_create',  '_route' => 'admin_user_user_create',);
                }

                // admin_user_user_batch
                if ($pathinfo === '/admin/user/user/batch') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::batchAction',  '_sonata_admin' => 'user.admin.user',  '_sonata_name' => 'admin_user_user_batch',  '_route' => 'admin_user_user_batch',);
                }

                // admin_user_user_edit
                if (preg_match('#^/admin/user/user/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_user_user_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'user.admin.user',  '_sonata_name' => 'admin_user_user_edit',));
                }

                // admin_user_user_delete
                if (preg_match('#^/admin/user/user/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_user_user_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'user.admin.user',  '_sonata_name' => 'admin_user_user_delete',));
                }

                // admin_user_user_show
                if (preg_match('#^/admin/user/user/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_user_user_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'user.admin.user',  '_sonata_name' => 'admin_user_user_show',));
                }

                // admin_user_user_export
                if ($pathinfo === '/admin/user/user/export') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::exportAction',  '_sonata_admin' => 'user.admin.user',  '_sonata_name' => 'admin_user_user_export',  '_route' => 'admin_user_user_export',);
                }
            ...
            if (0 === strpos($pathinfo, '/admin/log')) {
                if (0 === strpos($pathinfo, '/admin/login')) {
                    ...
                    if ($pathinfo === '/admin/login') {
                        return array (  '_controller' => 'UserBundle\\Controller\\AdminSecurityController::loginAction',  '_route' => 'sonata_user_security_login',);
                    }

                    // sonata_user_security_check
                    if ($pathinfo === '/admin/login_check') {
                        return array (  '_controller' => 'UserBundle\\Controller\\AdminSecurityController::logoutAction',  '_route' => 'sonata_user_security_check',);
                    }
                ...
                if ($pathinfo === '/admin/logout') {
                    return array (  '_controller' => 'UserBundle\\Controller\\AdminSecurityController::logoutAction',  '_route' => 'sonata_user_security_logout',);
                }
